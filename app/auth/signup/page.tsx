        ...
        <div className="right w-[60%] p-[20px]">
          ...
          >
            <div className="forminput_cont flex flex-col my-[10px] gap-[10px] w-[100%] relative">
              ...
              />
              {errors.name && (
                <span className="formerror text-[#ff0000]">{errors.name}</span>
              )}
            </div>
            <div className="forminput_cont flex flex-col my-[10px] gap-[10px] w-[100%] relative">
            ...
            <button
              type="submit"
              className="main_button bg-white text-[#f84464] font-semibold py-[15px] px-[32px] text-center text-[16px] border-none border-b border-[#f84464] mx-auto my-[10px] hover:bg-[#f84464] hover:text-white transition-all duration-300 rounded-lg"
            >
              Register
            </button>
            <p className="authlink text-[#333444]">
              Already have an account?{" "}
              <Link href="/auth/signin" className="text-[#f84464] font-medium">
                login
              </Link>
            </p>
          </form>
